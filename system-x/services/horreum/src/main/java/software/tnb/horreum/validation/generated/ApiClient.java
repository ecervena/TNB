...
public class ApiClient {
     ...
     */
    public ApiClient(String authName, Authentication authentication) {
        init();
        initHttpClient();
        addAuthentication(authName, authentication);
        // Setup authentications (key: authentication name, value: authentication).
        // Prevent the authentications from being modified.
        authentications = Collections.unmodifiableMap(authentications);
    }
     ...
     */
    public ApiClient(OkHttpClient client, String authName, Authentication authentication) {
        init();
        httpClient = client;
        addAuthentication(authName, authentication);
        // Setup authentications (key: authentication name, value: authentication).
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/0.17/java");
     ...
     *
     * @param type Name of the authentication e.g. ApiKey
     * @param auth An instance of authentication class
     * @return An instance of the client
     */
    public ApiClient addAuthentication(String type, Authentication auth) {
        this.authentications.put(type, auth);
        return this;
    }
